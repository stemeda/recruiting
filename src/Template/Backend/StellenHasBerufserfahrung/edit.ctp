<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $stellenHasBerufserfahrung->stellen_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $stellenHasBerufserfahrung->stellen_id)]
            )
        ?></li>
...
<div class="stellenHasBerufserfahrung form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Stellen Has Berufserfahrung') ?></legend>
        <?php
