<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $stellenHasZusatzqualifikationen->stellen_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $stellenHasZusatzqualifikationen->stellen_id)]
            )
        ?></li>
...
<div class="stellenHasZusatzqualifikationen form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Stellen Has Zusatzqualifikationen') ?></legend>
        <?php
