...
<script type="text/html" id="tmpl-addValue">
    <div class="form-group text">
        <label class="control-label" for="position-description-values-{%=o.current%}-name">
            Wert #{%=(o.current+1)%}
        </label>
        <input id="position-description-values-{%=o.current%}-name" class="form-control" name="position_description_values[{%=o.current%}][name]" maxlength="255" type="text">
    </div>
</script>

<script type="text/html" id="tmpl-addExtra">
    Wert #{%=(o.current+1)%}
    <input id="position-description-extras-{%=o.current%}-settings" name="position_description_extras[{%=o.current%}][settings]" type="hidden">
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group text">
                <label class="control-label" for="position-description-extras-{%=o.current%}-name">Name</label>
                <input id="position-description-extras-{%=o.current%}-name" class="form-control" name="position_description_extras[{%=o.current%}][name]" maxlength="255" type="text">
            </div>
        </div>
        <div class="col-sm-5">
            <div class="form-group text">
                <label class="control-label" for="position-description-extras-{%=o.current%}-type">Type</label>
                <select id="position-description-extras-{%=o.current%}-type" class="extraValueSelect form-control" name="position_description_extras[{%=o.current%}][type]" data-currentid="{%=o.current%}">
